...
#+begin_src emacs-lisp
(while (executable-find "autoreconf")
...
*Settings:*
#+begin_src emacs-lisp
(load-library "vterm") ;; In guix if you don't load before vterm-toggle it won't find the system emacs-vterm package???
