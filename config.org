...
(use-package evil-collection
  :after evil
  :config
  (evil-collection-init '(magit dired helpful))) ;; Enable for magit
#+end_src
...
(keymap-unset evil-motion-state-map "TAB") ;; Remove the default binding so org-cycle can take precedence
#+end_src
