...
(use-package evil-collection
  :after evil
  :config
  (evil-collection-init '(magit helpful))) ;; Enable for magit
#+end_src
...
+ [ ] Org-ret open at point now it wont oppen unless is litteraly inside of the link part not on the description

[[pdf:~/Downloads/pdf-tools as the default PDF viewer in Emacs.pdf::1][test]]
