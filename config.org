...
This is some extra config added over the default core.

** Additional keybindings

#+begin_src emacs-lisp
(define-key override-global-map (kbd "<f8>") #'goto-line)
(define-key override-global-map (kbd "<f11>") #'next-buffer)
(define-key override-global-map (kbd "<f12>") #'previous-buffer)
#+end_src

** Editing mode

*Use emacs state by default (change to evil with <C-z>)*
#+begin_src emacs-lisp
