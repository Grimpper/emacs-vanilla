...
(use-package dired-subtree
  :bind ;; Binds for emacs editing
  (:map dired-mode-map
              ("s" . nil) ;; Free the key
              ("s i" . dired-subtree-insert)
              ("s d" . dired-subtree-remove))
  :init
  ;; Binds for evil editing mode
  (with-eval-after-load 'evil-collection
    (evil-define-key* 'normal dired-mode-map "si" 'dired-subtree-insert)
    (evil-define-key* 'normal dired-mode-map "sd" 'dired-subtree-remove)))
#+end_src
